<template>
	<view class="content no-padding">
		...
		<view class="new-item-box" v-if="info.gridUsersList && gridType !=0">
		...
		<scroll-view class="swiper-box" scroll-y @scrolltolower="getmoreData()">
			<new-siper-item-wg class="swiper-item" v-for="item in info.microGridUser" :microGridAddress="info.microGridAddress" :item="item" @tousu="tousu(item)"></new-siper-item-wg>
			<view style="height:200rpx;width: 100%;float: left;"></view>
		</scroll-view>
		<view class="bottom-btn-box">
					<button class="bottom-float-button left-btn" type="red-border" @click="guanzhu">

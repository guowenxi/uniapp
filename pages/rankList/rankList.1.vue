	...
	<view class="content no-padding">
		...
		<view class="user-info-box">
			...
			<view class="info-box">
				...
				<view class="sub-name">
					<text>我在{{userInfo.districtName}} 排名<text class="font-orange">{{userInfo.rankNum}}</text></text>
		...
		<scroll-view class="scroll-bar" scroll-y="true">
			...
			:likeBtn="item.likeStatus || item.likeStatus == 0  ? true : false"
			:num="item.likeNum"

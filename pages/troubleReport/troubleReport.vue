<template>
	<view class="content no-padding">
			<scroll-view class="history-section icon" scroll-y>
				<view class="shangbao-time grey-bg" v-if="typeState">
					<view class="title color-333" style="margin-bottom:20rpx;">类型</view>
					<view class="time-box color-666">{{ taskInfo.fieldName }}</view>
				</view>
				...
				<textarea auto-height class="textarea-box" v-model="descrVal"  placeholder-style="color:#ccc" placeholder="请输入问题描述" @input="changeTextarea"  @confirm="changeTextarea"/>
					...
					<view class="title color-333 white-bg">详细地址</view>
					...
					<view class="default-item-box" v-if="!typeState">
...
import mInput from '../../components/m-input.vue'
	...
	export default {
		...
		onLoad(options){
			...
			this.typeState =  this.selListItem.fieldName !='' ? true : false;

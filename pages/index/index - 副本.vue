	...
	<view class="content no-padding">
		...
		<view class="cate-section">
			...
			<view class="cate-item" @click="bolNavTo('/pages/_new_weiwangge/_new_weiwangge')">
				<image src="/static/img/home_wangge@2x.png"></image>
				<text>微网格</text>
			</view>
...
export default {
	...
	getFyKeyConfig(){
		...
		getUnreadMessageList(){
			// this.popBox=[{
   //    "id": "0016d86eb62a458695b0a1ec32207a21",
   //    "message": "2020-03-23 20:00~21:00",
   //    "pushTime": "2019-10-23 16:07:17",
   //    "task_id":"02317db275a54514b6ea26ea7badd214",
   //    "status": 0,
	  // checked:false,
   //    "title": "测试任务",
   //    "userId": "ba021dcaa8914c38bf1782f325336e05",
   //    "userName": "巫宏超"
   //  }];

<template>
	<scroll-view  class="content no-padding swiper-box" scroll-y   @scrolltolower="getmoreData()">

			<new-siper-item-wg-more class="swiper-item" v-for="item in list" :item="item" @eventClick="selInfo(item)"></new-siper-item-wg-more>

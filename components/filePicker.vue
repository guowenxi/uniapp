<template>
	<view class="filePicker">
		...
		<view class="audio-box" v-if="audioList.length>0 ? true:false ">
			<view class="item" v-if="menuList[2].checkDisable">
				<view class="left-line" @click="recorderPlayState()">
					<view class="bofang" >
						<image class="img"
						:src=" !recorder_state ? '/static/_new/wwg_microphone@2x.png' : '/static/_new/wwg_microphone@2x.png'" 
						/>
					</view>
		...
		<view class="title color-333">照片</view>
		<view class="imgs-list" v-if="imgsList.length>0 ? true:false ">

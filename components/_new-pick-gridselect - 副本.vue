...
<view>
	...
	<view>
		<picker @click.stop="load_weiwangge(3)" @change="eventClick($event,3)" :value="index[3]" :range="list[3]" range-key="microGridName">
			<view class="uni-input">{{list[3][index[3]] ? list[3][index[3]].microGridName : ''}}</view>
		</picker>
	</view>
</view>
